                ...
                <ul class="nav navbar-nav" id="navbar-str">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" role="button"
                           aria-haspopup="true" aria-expanded="false">旅游新闻
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <ssm:sql var="mapxinwenfenlei1"
                                     type="select">SELECT id,fenleimingcheng FROM xinwenfenlei</ssm:sql>
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" role="button"
                           aria-haspopup="true" aria-expanded="false">景区信息
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
